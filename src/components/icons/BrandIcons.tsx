// Official brand marks (path data from simple-icons, CC0). fill="currentColor" so
// color is set via the wrapping element's text color class.
...
export function TwitchIcon(props: { size?: number; className?: string }) {
  return (
    <IconBase
      {...props}
...
export function YouTubeIcon(props: { size?: number; className?: string }) {
  return (
    <IconBase
      {...props}
...
export function KickIcon(props: { size?: number; className?: string }) {
  return (
    <IconBase
      {...props}
